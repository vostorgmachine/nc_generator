...
#
# 0.9:
# Начата работа над счетчиком инстанций. Современная версия хоть и заслуживает
# внимания, но концептуально уступает иной, с другим подходом (см
# соответствующую секцию кода)
#
# --------------------------------------------------------------------------------
# GOALS: 
#
# Добавить отображение кол-ва инстанций в файле
# По завершению реализации задачи уместно будет перейти к дальнейшему обучению.
# Пост-фактум вернуться к допиливанию проекта
# --------------------------------------------------------------------------------
# BUGS:
...
# ошибкой
#
# Теперь в большинстве(!) случаев при некорректном вводе программа не вылетает
# (Но однозначно необходимо дорабатывать и повышать "отказоустойчивость")
